                ...
                <ul class="space-y-2 pb-2">
                    ...
                    <li>
                        <a href="{{ url('/admin/podcast') }}"
                            ...
                            <span class="ml-3 flex-1 whitespace-nowrap">Podcast</span>
                        </a>
                    </li>


                    <li>
                        <a href="{{ url('/admin/video-edukasi') }}"
                            class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                            <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <span class="ml-3 flex-1 whitespace-nowrap">Video Edukasi</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ url('/admin/infografis') }}"
                            class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                            <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <span class="ml-3 flex-1 whitespace-nowrap">Infografis</span>
                        </a>
                    </li>

                    <li>
                        <a href="{{ url('/admin/film-edukasi') }}"
                            class="text-base text-gray-900 font-normal rounded-lg hover:bg-gray-100 flex items-center p-2 group ">
                            <svg class="w-6 h-6 text-gray-500 flex-shrink-0 group-hover:text-gray-900 transition duration-75"
                                fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                <path
                            ...
                            <span class="ml-3 flex-1 whitespace-nowrap">Film Edukasi</span>
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="{{ url('/admin/quote') }}"
                            ...
                            <span class="ml-3 flex-1 whitespace-nowrap">Quote</span>
                        </a>
                    </li>
